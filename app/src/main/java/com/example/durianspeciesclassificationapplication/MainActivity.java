...
public class MainActivity extends AppCompatActivity {
    public static final String EXTRA_TEXT = "com.example.durianspeciesclassificationapplication.EXTRA_TEXT";
    ...
    private void showresult(){
        ...
        double acc = Math.round(((0.01 - maxValueInMap) * 10000) * 100.0) / 100.0;
        ...
        //intent.putExtra(EXTRA_TEXT, accuracy);
